// node-diff3 v3.1.2 — https://github.com/bhousel/node-diff3 — MIT.
// Vendored verbatim (this banner aside) per the no-build rule: the ESM entry
// point has no dependencies, so it is served straight from /app/vendor/.
// `diff3MergeRegions(mine, base, theirs)` is the only export tome uses; see
// frontend/merge.js.
export {
  LCS,
  diffComm,
